<template>
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'echarts' })">
        <a class="site-navbar__brand-lg" href="javascript:;">门店管理</a>
        <a class="site-navbar__brand-mini" href="javascript:;">糖</a>
      </h1>
    </div>
        ...
        <el-menu-item class="site-navbar__avatar" index="3">
          <el-dropdown :show-timeout="0" placement="bottom">
            <span class="el-dropdown-link">
              <img src="~@/assets/img/logo2.png" :alt="userName">{{ userName }}
            </span>
